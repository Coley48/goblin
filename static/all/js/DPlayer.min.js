    ...
    return function(e) {
        ...
        var ee = function() {
            ...
            return t = e, (a = [{
                ...
                value: function() {
                    var e, t = this;
                    e = this.options.api.maximum ? "".concat(this.options.api.address, "?id=").concat(this.options.api.id, "&max=").concat(this.options.api.maximum) : "".concat(this.options.api.address, "?id=").concat(this.options.api.id);
                ...
                value: function(e, t) {
                    ...
                    this.options.apiBackend.send({ url: this.options.api.address, data: n, success: t, error: function(e) { a.options.error(e || a.options.tran("Danmaku send failed")) } }), this.dan.splice(this.danIndex, 0, n), this.danIndex++;
